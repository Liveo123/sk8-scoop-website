...
const sponsorMarkup = sponsor => {
  ...
  const imagePath = safeImagePath(sponsor.image_url);
  const image = imagePath
    ? `<div style="flex:0 0 116px"><img src="${esc(imagePath)}" alt="" loading="lazy" decoding="async" style="display:block;width:116px;height:92px;object-fit:cover;border-radius:13px"></div>`
    : '';
