export async function onRequestGet({request,env}){
  ...
  const totals=rows.reduce((a,r)=>({views:a.views+Number(r.views||0),form_submits:a.form_submits+Number(r.form_submits||0),live_posters:11}),{views:0,form_submits:0,live_posters:11});
